<?php /*a:1:{s:63:"D:\localhost\activity\application\admin\view\bespeak\index.html";i:1544059696;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="right-f">
  		<form class="layui-form" action="">
  		  <div class="layui-form-item">
			    ...
			    <div class="layui-input-inline">
			      <input type="text" name="bespeak_time" id="bespeak_time" autocomplete="off" class="layui-input">
			    </div>
...
<script id="createTime" type="text/html">
    {{#   
       return format(parseInt(d.bespeak_time) * 1000);
    }} 
</script>
