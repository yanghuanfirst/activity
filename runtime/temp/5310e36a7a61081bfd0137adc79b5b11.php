<?php /*a:1:{s:61:"D:\localhost\activity\application\admin\view\yuyue\index.html";i:1544173247;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  		...
  		<form class="layui-form" action="">
  		  <div class="layui-form-item">
			    ...
			    <div class="layui-input-inline">
			      <input type="text" name="username"  placeholder="请输入用户名或者手机号" autocomplete="off" class="layui-input">
			    </div>
...
<script id="createTime" type="text/html">
    {{#   
       return format(parseInt(d.yuyue_time) * 1000);
    }} 
</script>
...
<script src="/static/admin/js/yuyue.js"></script>
