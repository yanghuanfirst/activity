<?php /*a:1:{s:59:"D:\localhost\activity\application\admin\view\item\edit.html";i:1544164317;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<form class="layui-form" action="">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" value="<?php echo htmlentities($info['username']); ?>" name="username" required  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">标题</label>
    <div class="layui-input-block">
      <input type="text" value="<?php echo htmlentities($info['title']); ?>" name="title"  required  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
    <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" value="<?php echo htmlentities($info['tel']); ?>" name="tel"  required  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
			...
			<input type="hidden" name="item_img" value="<?php echo htmlentities($info['item_img']); ?>"/>
    </div>
    <label class="layui-form-label"></label>
    <div class="logo-img">
    	<img src="/uploads/<?php echo htmlentities($info['item_img']); ?>" style="width:100px;height:100px"/>
    </div>
  </div>
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      ...
      <input type="radio" name="sex" value="3" title="未知" <?php if($info['sex'] == '3'): ?>checked<?php endif; ?>>
    </div>
  </div>
